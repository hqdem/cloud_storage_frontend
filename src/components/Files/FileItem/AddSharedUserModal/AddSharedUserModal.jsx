...
import {addSharedUserToFile} from "../../../../api/files/apiFiles.js"

const AddSharedUserModal = ({fileId, isOpenSharedUserModal, setIsOpenSharedUserModal}) => {
    ...
    const onSubmitAddSharedUserClicked = (e) => {
        e.preventDefault()
        addSharedUserMutation1.mutate()
    }

    const addSharedUserMutation1 = useAuthMutation({
        func: () => {
            return addSharedUserToFile(fileId, {
                username: username
            }, JWTAccessToken)
        },
        onSuccessFunc: () => {
    ...
    return (
        ...
        >
            ...
            <form className={classes.form_dir}>
                {
                    addSharedUserMutation1.isLoading
                        ?
                        <div>Loading...</div>
                        :
                        null
